...
export const CHANNEL_PRESETS: ChannelPreset[] = [
  ...
  },
  {
    ...
    channels: { Social: 15, Search: 15, DOOH: 15, Radio: 15, CTV: 10, Display: 10, Linear: 5, Audio: 5, "Amazon/Prime Video/Twitch": 5, OLV: 5 },
    rationale: "Combines proximity-targeted social, DOOH, radio, and local media to drive physical visits.",
  },
  {
    id: "brand-demand", name: "Brand + Demand",
    description: "Build brand awareness while capturing demand",
    channels: { CTV: 15, Linear: 10, "YouTube/YouTubeTV": 10, Social: 10, Search: 15, Display: 10, OLV: 5, Audio: 5, Radio: 10, "Amazon/Prime Video/Twitch": 5, DOOH: 5 },
  ...
  },
  {
    ...
    channels: { Search: 20, Social: 15, Display: 10, OLV: 10, CTV: 10, "YouTube/YouTubeTV": 10, "Amazon/Prime Video/Twitch": 5, Linear: 5, Radio: 10, Audio: 5 },
...
export const DEFAULT_CHANNEL_MIX: Record<string, Record<string, number>> = {
  Awareness: { CTV: 20, Social: 15, Display: 15, OLV: 10, "YouTube/YouTubeTV": 10, Linear: 10, Radio: 5, Audio: 5, DOOH: 5, Search: 5 },
  Consideration: { Social: 20, Search: 15, "YouTube/YouTubeTV": 15, Display: 10, OLV: 10, CTV: 10, Email: 5, Audio: 5, DOOH: 5, Radio: 5 },
  Leads: { Search: 30, Social: 20, Display: 10, Email: 10, "YouTube/YouTubeTV": 10, CTV: 5, OLV: 5, Radio: 5, Audio: 5 },
  "Foot Traffic": { Social: 15, Search: 15, DOOH: 15, Radio: 15, CTV: 10, Display: 10, Linear: 5, Audio: 5, "Amazon/Prime Video/Twitch": 5, OLV: 5 },
  Conquest: { Search: 20, Social: 15, Display: 10, OLV: 10, CTV: 10, "YouTube/YouTubeTV": 10, "Amazon/Prime Video/Twitch": 5, Linear: 5, Radio: 10, Audio: 5 },
};
